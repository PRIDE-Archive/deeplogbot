...
The processed Parquet file covers the period January 2020 through January 2025 (Figure~\ref{fig:pride_overview}). For downstream analysis, records from 2020 were excluded due to incomplete annual coverage, restricting the study period to 2021--2025. Key metrics include 47.35 million total file downloads across 32,106 distinct projects, 2.26 million unique files, and 807,156 unique users. The analyzed projects represent 96.4\% of all public PRIDE datasets, and 88.0\% of PRIDE files have been downloaded at least once. Downloads originate from 136 countries with more than 100 downloads each.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/supp_pride_overview.png}
\caption{Overview of PRIDE download activity. The Parquet file covers 2020--2025; downstream analyses use 2021--2025 only. Overall scale metrics, reuse intensity across projects/files/users, file coverage, and geographic reach.}
